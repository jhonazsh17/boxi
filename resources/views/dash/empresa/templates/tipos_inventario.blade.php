<div class="row">
	...
	<div class="col-md-12 put-padding-1-top_and_bottom cont" style="height: 500px; overflow-y: auto; box-shadow: rgb(212, 212, 212) 0px 0px 8px 0px inset; background: #eeeeee3b;">
		<div class="row margin-1-bottom">
			<div class="col-md-8">											
				<p>
					Lista de Tipos de Inventarios registrados en 
			...
			<div class="col-md-4 text-right">
				<button class="btn btn-sad btn-sm" v-on:click="onClickNuevoTipoInventario()"><i class="fa fa-plus"></i> Nuevo Tipo de Inventario</button>
			</div>
		</div>
		<div class="row">
			<div class="col-md-12">
				<table class="table table-condensed table-hover table-striped" id="table-tinventarios">
					<thead>
						<tr>
							<th>N°</th>
